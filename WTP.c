...
*/
	...
	if(!CWParseSettingsFile()){
		//Elena: fprintf
		fprintf(stderr, "Can't start WTP: Can't parse setting file\n");
		exit(1);
	}
	...
	{
		fprintf(stderr, "Can't start WTP: Can't create SafeList for gPacketReceiveList\n");
		CWLog("Can't start WTP: Can't create SafeList for gPacketReceiveList");
		exit(1);
	}
	...
	{
		fprintf(stderr, "Can't start WTP: Can't create SafeList for gPacketReceiveDataList\n");
		CWLog("Can't start WTP: Can't create SafeList for gPacketReceiveDataList");
		exit(1);
	}
	...
	{
		fprintf(stderr, "Can't start WTP: Can't create SafeList for gFrameList\n");
		CWLog("Can't start WTP: Can't create SafeList for gFrameList");
		exit(1);
	}

	fprintf(stdout, "Setting up WTP Threads and Mutexes...\n");
