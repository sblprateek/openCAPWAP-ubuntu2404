...
# Add for testing (BY EQQIE)
CFLAGS += -DFOREGROUND
CFLAGS += -DCWLOG_IN_VFPRINTF
CFLAGS += -DIPV6
...
AC_OBJS = AC.o ACConfigFile.o ACMainLoop.o ACDiscoveryState.o ACJoinState.o \
	...
	CWRandom.o CWSecurityStubs.o CWStevens.o CWThread.o CWBinding.o CWVendorPayloadsAC.o \
...
WTP_OBJS = WTP.o WTPFrameReceive.o WTPFreqStatsReceive.o WTPStatsReceive.o WTPConfigFile.o WTPProtocol.o WTPProtocol_User.o \
	...
	CWProtocol.o CWRandom.o CWSecurityStubs.o CWStevens.o CWThread.o CWBinding.o CWVendorPayloadsWTP.o WTPBinding.o \
